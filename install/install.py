...
# get dirs
P_DIR_USR_INST = Path.home() / ".local/share/cnlib"
P_DIR_VENV = P_DIR_USR_INST / ".venv-cnlib"

# get files
P_FILE_DESK = P_DIR_ASSETS / "src/gui/desktop/CNLib.desktop"
P_FILE_DESK_ICON = Path.home() / ".local/share/cnlib/images/cnlib.png"
